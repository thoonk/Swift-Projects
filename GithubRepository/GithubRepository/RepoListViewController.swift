...
final class RepoListViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(RepoListCell.self, forCellReuseIdentifier: RepoListCell.identifier)
    ...
    func fetchRepositories(of organization: String) {
        Observable.from([organization])
            .map { org -> URL in
                return URL(string: "https://api.github.com/orgs/\(org)/repos")!
            }
...
extension RepoListViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(
            withIdentifier: RepoListCell.identifier,
            for: indexPath
